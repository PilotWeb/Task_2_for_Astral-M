        ...
        <div class="report">
            ...
            <div class="osno-doc">
             <h5>Отчетность ООО на ОСНО включает в себя следующую документацию:</h5>
                ...
                <div>
                    <img src="images/EO_ТZ-6__50.png" height="147" width="150" alt="Отчетность ООО на ОСНО">
                </div>
                    <ul>
             ...
             <h5>Отчетность ИП на ОСНО:</h5>
                <div class="osno-doc-view clearfix">
                <div>
                 <img src="images/EO_ТZ-6__48.png" height="147" width="150" alt="Отчетность ИП на ОСНО:">
                </div>
